  ...
  const deleteResume = async (resumeId) => {
    try {
      const confirm = window.confirm(
        "ARE YOU USRE YOU WANT TO DELETE THIS  RESUME?",
      );
      if (confirm) {
          ...
          >
            ...
            >
              ...
              <input
                ...
                className="w-full px-4 py-2 mb-4 border border-green-600 ring-green-600 focus:border-green-600"
                required
              />
            ...
            >
              ...
              <div>
                <label
                  ...
                  className="blockk text-sm  text-slate-700"
                >
                  Select Resume File
                  <div
